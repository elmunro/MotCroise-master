...
TESTS_TME3="\
 pobj.motx.tme3.test.GrilleSolverTestEasy \
 pobj.motx.tme3.test.GrilleSolverTestMedium \
 pobj.motx.tme3.test.GrilleSolverTestHard \
 pobj.motx.tme3.test.GrilleSolverTestLarge2 \
 pobj.motx.tme3.test.GrilleSolverTestLarge \
"
